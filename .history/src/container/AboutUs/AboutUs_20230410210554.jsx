...
const AboutUs = () => (
  <div className='app__aboutus app__bg flex__center section__padding' id='about'>
    <div className='app__aboutus-overlay flex__center' >
      <img src={images.restoran} alt="g letter"  style={{width: '44%', height: 'auto',marginTop: '-400px'}}/>
    </div>
    ...
    <img src={images.knife} style={{width: '44%', height: 'auto',marginTop: '-400px'}} alt="about_knife"  />
      <div className='app__aboutus-content_about'>
